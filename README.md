...
```bash
npm install --save-dev eslint-config-alloy@1.0.0-beta.2 babel-eslint
```
...
```bash
npm install --save-dev eslint-config-alloy@1.0.0-beta.2 eslint-plugin-react babel-eslint
```
