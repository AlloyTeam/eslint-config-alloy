...
- 对于能够 autofix 的配置，在注释中有标注了 `@autofix`
...
```bash
npm install --save-dev eslint typescript @typescript-eslint/eslint-plugin eslint-plugin-react eslint-config-alloy@2.0.0-alpha.2
```
